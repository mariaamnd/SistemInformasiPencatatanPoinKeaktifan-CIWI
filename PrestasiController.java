...
public class PrestasiController implements Initializable{
    ...
    public void showPrestasi(){
        ...
        colBukti.setCellValueFactory(new PropertyValueFactory<Prestasi, String>("Image"));
        colValidasi.setCellValueFactory(new PropertyValueFactory<Prestasi, String>("StatusValidasi"));
    ...
    private void insertRecord(){
        String query = "INSERT INTO KegiatanPrestasi VALUES (" + IDTextField.getText() + ", '" + combobox.getValue() + "', '" + combobox1.getValue() + "', '" + KeteranganTextField.getText()+ "', '" + TanggalTextField.getValue()+ "'," + labelPoin.getText()+ ", '" + listView.getItems()+ "', '" + "' )";
        executeQuery(query);
        search();
        showPrestasi();
    }
    ...
    private void updateRecord(){
        String query = "UPDATE KegiatanPrestasi SET JenisPrestasi = '" + combobox.getValue() + "',  TingkatPrestasi = '" + combobox1.getValue() + "' , Keterangan = '" + KeteranganTextField.getText() + "' , Tanggal = '" + TanggalTextField.getValue() + "' , Poin = " + labelPoin.getText() + " , Image = '" + listView.getItems()+ "' , StatusValidasi = '" + "' WHERE IDPrestasi = " + IDTextField.getText() + "";
        executeQuery(query);
        search();
        showPrestasi();
