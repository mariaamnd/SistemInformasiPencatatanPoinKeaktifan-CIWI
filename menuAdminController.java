...
public class menuAdminController {
    ...
    @FXML
    private Button buttonLaporanPoin;  
    ...
    @FXML
    private void switchToValidasi() throws IOException {
        App.setRoot("Validasi");
    }
    ...
    @FXML
    private void switchToLaporanPoin() throws IOException {
        App.setRoot("Grafik");
    }
    @FXML
